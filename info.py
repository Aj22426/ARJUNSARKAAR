...
MELCOW_VID = environ.get("MELCOW_VID", "https://envs.sh/gdx.mp4")
...
DATABASE_NAME = environ.get('DATABASE_NAME', "ARJUNSARKAAR")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'arjunsarkaar')
