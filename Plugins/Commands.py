...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton("Updates", url="https://t.me/moviesxyz_ofcl"),
                InlineKeyboardButton("Updates Channel", url="https://t.me/ajbotsofcl ")
            ]
            ]
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('Update Channel', url=f'https://t.me/AJBOTSOFCL')
            ],[
            InlineKeyboardButton('♻️ Update Channel ♻️', url=f'https://t.me/MOVIESXYZ_OFCL')
            ],[
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help", "start", "hehe"]:
        ...
        buttons = [[
            InlineKeyboardButton('Update Channel', url=f'http://youtube.com/ajbotsofcl')
            ],[
            InlineKeyboardButton('♻️ Update Channel ♻️', url=f'https://t.me/moviesxyz_ofcl')
            ],[
            InlineKeyboardButton('ℹ️ 𝙷𝚎𝚕𝚙', callback_data='help'),
    ...
    await client.send_cached_media(
        ...
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton("Update Channel", url="https://t.me/ajbotsofcl")] ] ),
